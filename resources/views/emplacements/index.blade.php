                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-header-action">
                                    <a href="{{ route('emplacements.create')}}" class="btn btn-icon icon-left btn-success"><i class="fas fa-plus"></i> Ajouter un emplacement</a>
                                </div>   
                            </div>
                            <div class="card-body">
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a href="{{ route('emplacements.edit', $emplacement->id)}}" class="dropdown-item has-icon"><i class="far fa-edit text-primary"></i> Modifier</a>
