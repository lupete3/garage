            ...
            <div class="section-body ">
                ...
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12 align-center">
                        ...
                        @endif
                      <div class="card ">
                        <form method="post" action="{{ route('sorties.store')}}" enctype="multipart/form-data">
                            @csrf
                          ...
                          <div class="card-body">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="personne" value="{{ old('personne') }}" placeholder="" required="">
                            </div>
